  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Available Templates</h1>
          <p className="text-gray-500 text-sm">Select a template to fill and submit for approval.</p>
        </div>
                        ...
                        return (
                          <tr key={template._id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4 text-sm text-gray-600 min-w-[300px]">
                              <p className="line-clamp-1">{template.description || "—"}</p>
                            </td>
