  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50 overflow-hidden">
      ...
      <motion.div
        ...
        className="hidden lg:flex w-1/2 relative bg-indigo-700 text-white"
      >
      ...
      >
        <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-gray-100">
          {/* Mobile Branding */}
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-600"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition disabled:opacity-70"
            >
              {loading ? (
