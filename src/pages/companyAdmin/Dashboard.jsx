...
export default function CompanyAdminDashboard() {
  ...
  const statCards = [
    { title: "Total Plants", value: stats.totalPlants, icon: <Factory className="w-7 h-7" />, color: "blue" },
    { title: "Active Forms", value: stats.totalForms, icon: <FileText className="w-7 h-7" />, color: "indigo" },
    { title: "Submissions", value: stats.totalSubmissions, icon: <CheckCircle2 className="w-7 h-7" />, color: "green" },
    { title: "Pending Review", value: stats.pendingSubmissions, icon: <AlertCircle className="w-7 h-7" />, color: "amber" },
  ];
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-50 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400 font-semibold mt-1 uppercase tracking-wider">Live stream from all units</p>
            </div>
