          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
              <div className="space-y-0.5">
                <h3 className="text-sm font-bold text-slate-900">Template Management</h3>
                <p className="text-xs text-slate-500">Allow plants to create and reuse form templates.</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input 
                  type="checkbox" 
                  className="sr-only peer"
                  checked={company.isTemplateManagementEnabled}
                  onChange={(e) => setCompany({ ...company, isTemplateManagementEnabled: e.target.checked })}
                />
