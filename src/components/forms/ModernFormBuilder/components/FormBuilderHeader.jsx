    ...
    <header className="h-14 bg-white border-b border-gray-100 flex items-center justify-between px-4 shrink-0 z-30">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <input 
            ...
            placeholder={isTemplate ? "Untitled Template" : "Untitled Form"}
          ...
          <div className="flex items-center gap-2">
            <span className={`px-2 py-0.5 text-[10px] font-medium rounded-full border ${
              ...
              {status === 'PUBLISHED' ? 'Published' : isTemplate ? 'Draft Template' : 'Draft Form'}
            </span>
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          {isTemplate ? "Publish Template" : "Publish Form"}
        </button>
      </div>
    </header>
  );
